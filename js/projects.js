const PROJECTS_DATA = [
  {
    slug: "sala-vip-teatro-nuevo-apolo",
    name: "SALA VIP TEATRO NUEVO APOLO",
    category: "COMERCIAL",
    location: "Madrid",
    year: "2025",
  ...
  {
    slug: "sala-vip-teatro-nuevo-alcala",
    name: "SALA VIP TEATRO NUEVO ALCALÁ",
    category: "COMERCIAL",
    location: "Madrid",
    year: "2025",
  ...
  {
    slug: "vivienda-unifamiliar-cotos-de-monterrey",
    name: "VIVIENDA UNIFAMILIAR COTOS DE MONTERREY",
    category: "OBRA NUEVA",
    location: "Madrid",
    year: "",
  ...
  {
    slug: "vivienda-unifamiliar-los-alamos-de-bularas",
    name: "VIVIENDA UNIFAMILIAR LOS ÁLAMOS DE BULARAS",
    category: "OBRA NUEVA",
    location: "Madrid",
    year: "",
  ...
  {
    slug: "vivienda-unifamiliar-la-finca",
    name: "VIVIENDA UNIFAMILIAR LA FINCA",
    category: "OBRA NUEVA",
    location: "Madrid",
    year: "",
  ...
  {
    slug: "oficinas-grupo-oesia",
    name: "OFICINAS GRUPO OESÍA",
    category: "OFICINAS",
    location: "Sevilla",
    year: "",
  ...
  {
    slug: "vivienda-unifamiliar-prado-largo",
    name: "VIVIENDA UNIFAMILIAR PRADO LARGO",
    category: "OBRA NUEVA",
    location: "Madrid",
    year: "",
...
function projectCard(project) {
  return `
    <a
      href="${siteUrl(`proyectos/detalle.html?slug=${project.slug}`)}"
      class="group block"
    >
<div class="relative w-full aspect-[16/10] bg-neutral-100 overflow-hidden">
        ...
        <!-- CAPA OSCURA -->
        <div
          class="absolute inset-0 bg-black/0 group-hover:bg-black/55 transition-colors duration-300"
        ></div>
        ...
        >
          <span
            class="text-white text-[14px] md:text-[15px]
      ...
      ${currentProjectImages.map((img, i) => `
        <button
          ...
          class="project-lightbox-thumb ${
            i === currentLightboxIndex ? "is-active" : ""
          }"
...
function updateProjectLightbox() {
  ...
  if (image) {
    image.src = siteUrl(
      currentProjectImages[currentLightboxIndex]
    );
  }
